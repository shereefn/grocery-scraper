...
TEST_STORES = ["LULU Hypermarket", "Hyper Panda", "Othaim Markets", "Nesto", "eXtra", "Danube", "Mark & Save", "Grand Hyper", "Hyper Al Wafa", "Al Madina Hypermarket", "Jarir Bookstore","SACO","Home Box","Carrefour","City Flower","Tamimi Market"]
TARGET_PRODUCTS = [] 
